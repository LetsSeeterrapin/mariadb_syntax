...
-- 제약조건의 이름 확인 후 삭제및 추가 가능
-- 제약조건 조회
select * from information_schema.key_column_usage where table_name = 'post';
-- 제약조건 삭제
alter table post drop foreign key post_ibfk_1;
-- 제약조건 추가
alter table post add constraint post_author_fk foreign key(author_id) references author_id;
...
-- default 옵션
alter table author modify collumn name vachar(255) default 'anonymous';
-- auto_increment
